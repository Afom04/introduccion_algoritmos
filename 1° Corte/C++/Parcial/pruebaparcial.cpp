	...
	if(digitos%2==0) {
		if(digitos==4) {
			if(digito4>0) {
				...
				if(primo==true) {
					cout<<"El ganador del premio de un millón de peses es el empleado con el numero #" <<digito4 <<endl<<endl<<endl;
				} else {
					primo=true;
					...
					if(primo==true) {
						cout<<"El ganador del premio de un millón de peses es el empleado con el numero #" <<digito5 <<endl<<endl<<endl;
					} else {
